...
func TestHelloFrame(t *testing.T) {
	...
	want := "50380100000102030405060708090a0b0c0d0e0f000036002800546573744170700000000000000000005039534e303030303030303000000000322e312e30000000000000000000000000000800"
	if got != want {
		t.Fatalf("hello\n got=%s\nwant=%s", got, want)
	}
}
